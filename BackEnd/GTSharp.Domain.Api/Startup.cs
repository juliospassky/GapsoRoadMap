...
namespace GTSharp.Domain.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<CommentHandler, CommentHandler>();
            services.AddTransient<ICourseRepository, CourseRepository>();
            services.AddTransient<CourseHandler, CourseHandler>();
            services.AddTransient<INodeRepository, NodeRepository>();
            services.AddTransient<NodeHandler, NodeHandler>();
            services.AddTransient<IRecomendationRepository, RecomendationRepository>();
            services.AddTransient<RecomendationHandler, RecomendationHandler>();
            services.AddTransient<IRoadMapRepository, RoadMapRepository>();
            services.AddTransient<RoadMapHandler, RoadMapHandler>();
            services.AddTransient<ISubtitleRepository, SubtitleRepository>();
            services.AddTransient<SubtitleHandler, SubtitleHandler>();
